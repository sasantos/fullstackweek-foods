...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_resraurantId_fkey" FOREIGN KEY ("resraurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
